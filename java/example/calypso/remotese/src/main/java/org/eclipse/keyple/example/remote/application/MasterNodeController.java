...
public class MasterNodeController {
     ...
     */
    public MasterNodeController(final TransportFactory transportFactory, Boolean isServer,
    ...
    public void boot() {
        try {
            ...
            ((ObservablePlugin) rsePlugin).addObserver(
                    new RemoteSePluginObserver(masterAPI, samResourceManager, node.getNodeId()));
