...
/**
 * SV Undebit (00BC) response parser. See specs: Calypso Stored Value balance (signed binaries'
 ...
 * <p>
 * amount for undebit - Integer 0..32767 =&gt; for positive value
 * 
 * <pre>
             0           %00000000.00000000
             1           %00000000.00000001
 ...
 * </pre>
 */
public final class SvUndebitRespPars extends AbstractPoResponseParser {
     ...
     */
    public SvUndebitRespPars(ApduResponse response) {
        super(response);
    ...
    public String toString() {
        return String.format("SV Undebit");
    }
}
